...
2. **Draft the Document**: Your specification MUST include:
   ...
   - **Architecture & Tech Stack**: Reiterate the current project's stack (Laravel / PHP / Eloquent). Detail which Controllers, Services, and Models need to be created or modified.
   - **Data Flow & State**: Briefly outline how data should flow from the database to the API response.
